...
const shedinja: PokemonInstance = {
    ...
    types: ['Bug', 'Ghost'],
    currentStats: { hp: 1, attack: 100, defense: 100, spAttack: 100, spDefense: 100, speed: 100 },
    currentHp: 1,
    ability: 'Wonder Guard',
    level: 50, ivs: {}, evs: {}, moves: [], status: 'None', volatile: {}, originalTrainer: '', statStages: {}
} as any;

const jolteon: PokemonInstance = {
    uuid: 'p2', speciesId: 'jolteon', nickname: 'Jolteon',
    types: ['Electric'],
...
const arcanine: PokemonInstance = {
    uuid: 'p3', speciesId: 'arcanine', nickname: 'Arcanine',
    types: ['Fire'],
    currentStats: { hp: 100, attack: 100, defense: 100, spAttack: 100, spDefense: 100, speed: 100 },
    currentHp: 100,
    ability: 'Flash Fire',
...
// Moves
const scratch: MoveData = { id: 'scratch', name: 'Scratch', type: 'Normal', category: 'Physical', power: 40, accuracy: 100, target: 'SelectedEnemy', effects: [{type: 'Damage'}], pp: 35, priority: 0, description: 'Scratches the foe.' };
const flamethrower: MoveData = { id: 'flamethrower', name: 'Flamethrower', type: 'Fire', category: 'Special', power: 90, accuracy: 100, target: 'SelectedEnemy', effects: [{type: 'Damage'}], pp: 15, priority: 0, description: 'Burns the foe.' };
const thunderbolt: MoveData = { id: 'thunderbolt', name: 'Thunderbolt', type: 'Electric', category: 'Special', power: 90, accuracy: 100, target: 'SelectedEnemy', effects: [{type: 'Damage'}], pp: 15, priority: 0, description: 'Zaps the foe.' };
...
async function runTests() {
    ...
    const res1 = MoveEngine.executeMove(jolteon, shedinja, scratch);
    ...
    const res2 = MoveEngine.executeMove(arcanine, shedinja, flamethrower);
