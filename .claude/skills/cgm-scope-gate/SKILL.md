...
Claude and Codex should both treat this skill as binding process. If a platform-specific instruction conflicts with repo documents, stop and report the conflict instead of improvising.
