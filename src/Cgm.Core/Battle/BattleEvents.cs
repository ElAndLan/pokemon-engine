...
public enum MoveFailureReason
{
    ...
    ActionOrderRequirementNotMet,
    TargetActionRequirementNotMet,
    InterruptedByDamage,
    DamageRequired,
    TargetUnavailable,
    FormulaInputUnavailable,
    TerrainRequired,
...
public sealed record MoveReplaced(BattleSlot Slot, int MoveSlot, EntityId Move) : BattleEvent
{
    public BattleSide Side => Slot.Side;
}
