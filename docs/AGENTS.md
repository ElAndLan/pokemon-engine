...
| Battle formulas, effect ops, events, AI | BATTLE_SYSTEM_SPEC.md + MOVE_AUDIT_SYSTEM_PLAN.md | **Phase 15 active** - 15B plus the 15C-1 query, 15D-1 intent, and 15E-1 condition-store foundations are complete; 57 generated certifications; 15E-2 is next |
