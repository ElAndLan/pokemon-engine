...
| Battle formulas, effect ops, events, AI | BATTLE_SYSTEM_SPEC.md + MOVE_AUDIT_SYSTEM_PLAN.md | **Phase 15 active** - 15B-15F, 15G-1/2/3 are complete; 15G-4 is active through the reusable status-cure family at 275 generated certifications |
...
| Phase status and current/future work | IMPLEMENTATION_PLAN.md | **Executable v4.0; Phase 15 active at 275/937 strict certification** |
