...
| Battle formulas, effect ops, events, AI | BATTLE_SYSTEM_SPEC.md + MOVE_AUDIT_SYSTEM_PLAN.md | **Phase 15 active** - 15B and the 15C-1 unified query foundation are complete; 57 generated certifications; 15D-1 is next |
