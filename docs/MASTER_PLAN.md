...
2026-07-10 scope rebase: `ARCHITECTURE_ADDENDUM.md`, `SCOPE_GUARD.md` v3.1, and
`IMPLEMENTATION_PLAN.md` v3.1 supersede this document's older phase assignments and its treatment of
